...
produces PR #3. Implements the gold standard for CI: lint, test, build,
...
SHAs from the target repo's existing workflows or from well-known action releases as the reference. All
